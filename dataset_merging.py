...
class MergeSimilarDataset():
    ...
    def qq_plot(self, df_samp, df_clu):
        ...
        print "Start drawing Q-Q plot using data from sample %s and cluster {}.".format(samp_id, ref_id)
    ...
    def merge_similar_dataset(self, qq_slope_range=(0.85, 1.15), qq_intercept=10, override=True):
        ...
        ids, train_files = get_ids_and_files_in_dir(self.input_dir, self.enter_id_range)
        _, itv_files = get_ids_and_files_in_dir(self.input_dir, self.enter_id_file, input_file_regx="(\d+).interval.csv")
        ...
        if not os.listdir(interval_dir):
            ...
            raise ValueError("No files found in {}".format(interval_dir))
        ...
        for samp_index, samp_file in enumerate(itv_files):
            ...
            df_samp_fil = percentile_remove_outlier(df_samp, 1, 1+self.dataset_length)
            ...
            for ref_index, ref_file in enumerate(cluster_interval_files):
                ...
                df_clu_fil = percentile_remove_outlier(df_clu, 1, 1+self.dataset_length)
    ...
    @staticmethod
    def merge_selected_dataset(clustering_ref_file, indir=".", infile_suffix="csv", outdir=".", outfile_prefix="merge"):
        """
...
def main():
    cluster_file = "C:/Users/fanzo/Desktop/RNN_prediction/cluster/cluster-consists-info.csv"
    output_dir = "C;/Users/fanzo/Desktop/RNN_prediction/cluster"
    input_dir = "C:/Users/fanzo/Desktop/RNN_prediction/enterprises"  # generated by trainingset_selection script
