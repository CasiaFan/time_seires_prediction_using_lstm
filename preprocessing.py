...
def read_df_from_mysql_db(localhost, username, password, dbname, tbname, fields, chunksize=None, time_field=None, start_time=None, end_time=None):
    ...
    :param time_field: field in mysql table define the time field
